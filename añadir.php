...
<body>
    ...
    <div class="container">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['guardar'])) {
            ...
            $sexo= $_POST['sexo'];
            $año_escolar = $_POST['año_escolar']; // Nuevo campo para el año a cursar
            ...
            // Inserta los datos en la tabla de la base de datos, incluyendo el año a cursar
            $sql = "INSERT INTO alumnos (id_alumno, nombre, apellido,direccion,telefono,sexo,fecha_nacimiento, año_escolar) VALUES ('$cedula', '$nombre', '$apellido','$direccion','$telefono','$sexo', '$fecha_nacimiento' ,'$año_escolar')";
        ...
        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="sexo" class="form-control" id="sexo" list="opcionesSexo" required>
        <!-- Lista de opciones de sexo -->
        <datalist id="opcionesSexo">
